...
- Check the status of the Jenkins first.

`service jenkins status`

![image](https://github.com/vistasunil/CT_DevOps_WS_Module3/assets/37858762/85398f2d-016c-4107-b9d7-50870803a9cd)
...
2. Create a Jenkins job to clone repo **_https://github.com/vistasunil/devopsIQ.git_** and deploy the website inside it the slave instance in container.
